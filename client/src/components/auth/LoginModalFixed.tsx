...
const LoginModalFixed: React.FC<LoginModalProps> = ({ isOpen, onClose, onSwitchToRegister }) => {
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // API isteği yap - authApi.login kullanarak düzgün şekilde çağrı yapalım
      ...
      if (response && response.token) {
        ...
        setError(getAuthMessage('login_failed', currentLanguage));
      }
    } catch (error) {
      console.error('Login hatası:', error);
      setError(getAuthMessage('login_error', currentLanguage));
    } finally {
  ...
  return (
    <div className="fixed inset-0 z-[99999]" style={{backgroundColor: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(2px)'}}>
      ...
      <div className="fixed top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/3 w-full max-w-md bg-gradient-to-b from-[#1E1E1E] to-[#121212] rounded-xl border border-[#2A2A2A] shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3.5 bg-[#1A1A1A] border-2 border-[#333] focus:border-[#FFD700] rounded-lg focus:outline-none text-white placeholder-gray-500 transition-all duration-200 shadow-sm text-sm"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-12 py-3.5 bg-[#1A1A1A] border-2 border-[#333] focus:border-[#FFD700] rounded-lg focus:outline-none text-white placeholder-gray-500 transition-all duration-200 shadow-sm text-sm"
